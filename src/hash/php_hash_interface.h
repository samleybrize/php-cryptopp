...
#define CRYPTOPP_HASH_GET_NATIVE_PTR() static_cast<HashInterfaceContainer *>(zend_object_store_get_object(getThis() TSRMLS_CC))->hash
...
extern zend_class_entry *cryptopp_ce_HashInternalInterface;
