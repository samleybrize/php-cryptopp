...
static zend_function_entry cryptopp_methods_HashSha3_256[] = {
    ...
    CRYPTOPP_HASH_GET_REQUIRED_METHODS(HashSha3_256)
    PHP_FE_END
};
...
{
    CRYPTOPP_HASH_GET_INIT_CLASS_FUNC_CALL(HashSha3_256)
}
...
CRYPTOPP_HASH_GET_REQUIRED_METHODS_DEFINITIONS(HashSha3_256, CryptoPP::SHA3_256)
