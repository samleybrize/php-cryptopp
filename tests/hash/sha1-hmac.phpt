...
$hmac->setKey(hex2bin("0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b"));
var_dump(bin2hex($hmac->calculateDigest("Hi There")));

$hmac->setKey("Jefe");
var_dump(bin2hex($hmac->calculateDigest("what do ya want for nothing?")));

$hmac->setKey(hex2bin("aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa"));
...
$hmac->setKey(hex2bin("0c0c0c0c0c0c0c0c0c0c0c0c0c0c0c0c0c0c0c0c"));
