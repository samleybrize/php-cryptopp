...
// encrypt without key
echo "- no key:\n";
$o = new Cryptopp\SymmetricModeCtr(new Cryptopp\BlockCipherAes());
...
// test inheritance
echo "- inheritance:\n";
class Child extends Cryptopp\SymmetricModeCtr{}
...
class ChildParentConstructorNotCalled extends Cryptopp\SymmetricModeCtr
{
