...
$o->setIv(Cryptopp\HexUtils::hex2bin("000102030405060708090a0b0c0d0e0f"));
var_dump(Cryptopp\HexUtils::bin2hex($o->decrypt(Cryptopp\HexUtils::hex2bin("3b3fd92eb72dad20333449f8e83cfb4a7789508d16918f03f53c52dac54ed825"))));
var_dump(Cryptopp\HexUtils::bin2hex($o->decrypt(Cryptopp\HexUtils::hex2bin("9740051e9c5fecf64344f7a82260edcc304c6528f659c77866a510d9c1d6ae5e"))));
