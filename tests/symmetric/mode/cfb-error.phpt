...
// encrypt without key
echo "- no key:\n";
$o = new Cryptopp\SymmetricModeCfb(new Cryptopp\BlockCipherAes());
...
// test inheritance
echo "- inheritance:\n";
class Child extends Cryptopp\SymmetricModeCfb{}
...
class ChildParentConstructorNotCalled extends Cryptopp\SymmetricModeCfb
{
