...
// encrypt without key
echo "- no key:\n";
$o = new Cryptopp\SymmetricModeOfb(new Cryptopp\BlockCipherAes());
...
// test inheritance
echo "- inheritance:\n";
class Child extends Cryptopp\SymmetricModeOfb{}
...
class ChildParentConstructorNotCalled extends Cryptopp\SymmetricModeOfb
{
