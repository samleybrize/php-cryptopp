...
$o->restart();
var_dump(bin2hex($o->decrypt(hex2bin("c7619d385ff57fad9c9ab9e7d2fa6334"))));
var_dump(bin2hex($o->decrypt(hex2bin("9067a70e21e095f254c482f8e0fc2161"))));
...
$o->restart();
var_dump(bin2hex($o->decrypt(hex2bin("4e26530489778baff97e6c8c6f650e3f"))));
var_dump(bin2hex($o->decrypt(hex2bin("f9e95b4282bac9253d552bad7f7890a6"))));
