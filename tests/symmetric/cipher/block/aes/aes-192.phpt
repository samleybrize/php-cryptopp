...
// encryptBlock
echo "- encrypt block:\n";
$o->setKey(hex2bin("8e73b0f7da0e6452c810f32b809079e562f8ead2522c6b7b"));
...
// decryptBlock
echo "- decrypt block:\n";
var_dump(bin2hex($o->decryptBlock(hex2bin("bd334f1d6e45f25ff712a214571fa5cc"))));
var_dump(bin2hex($o->decryptBlock(hex2bin("974104846d0ad3ad7734ecb3ecee4eef"))));
...
// decrypt
echo "- decrypt:\n";
var_dump(bin2hex($o->decrypt(hex2bin("bd334f1d6e45f25ff712a214571fa5cc974104846d0ad3ad7734ecb3ecee4eef"))));
var_dump(bin2hex($o->decrypt(hex2bin("ef7afd2270e2e60adce0ba2face6444e9a4b41ba738d6c72fb16691603c18e0e"))));
