...
// decryptBlock
echo "- decrypt block:\n";
var_dump(Cryptopp\HexUtils::bin2hex($o->decryptBlock(Cryptopp\HexUtils::hex2bin("3ad77bb40d7a3660a89ecaf32466ef97"))));
var_dump(Cryptopp\HexUtils::bin2hex($o->decryptBlock(Cryptopp\HexUtils::hex2bin("f5d3d58503b9699de785895a96fdbaaf"))));
...
// decrypt
echo "- decrypt:\n";
var_dump(Cryptopp\HexUtils::bin2hex($o->decrypt(Cryptopp\HexUtils::hex2bin("3ad77bb40d7a3660a89ecaf32466ef97f5d3d58503b9699de785895a96fdbaaf"))));
var_dump(Cryptopp\HexUtils::bin2hex($o->decrypt(Cryptopp\HexUtils::hex2bin("43b1cd7f598ece23881b00e3ed0306887b0c785e27e8ad3f8223207104725dd4"))));
