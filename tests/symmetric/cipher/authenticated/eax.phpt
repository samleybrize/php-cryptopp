...
$o->setIv(hex2bin("cafebabefacedbaddecaf888"));
$c->setKey(hex2bin("feffe9928665731c6d6a8f9467308308"));
var_dump(bin2hex($o->decrypt(hex2bin("206760741b9e5b75eaa69c401709f41b67b9b92d559953f31a892d17619f14ee"))));
var_dump(bin2hex($o->decrypt(hex2bin("8ca8c56d81522be3831d4503b1903302079b7863c7e4d8869196996e6061c60a"))));
...
$o->decrypt(hex2bin("206760741b9e5b75eaa69c401709f41b67b9b92d559953f31a892d17619f14ee"));
$o->decrypt(hex2bin("8ca8c56d81522be3831d4503b1903302079b7863c7e4d8869196996e"));
var_dump(bin2hex($o->finalizeDecryption()));
